...
function Footer() {
    return (
        <div className='bg-zinc-900 w-full h-screen flex justify-between pt-14 px-5 '>
            <div className="w-1/2  text-white ">
                <h1 className='text-7xl font-extrabold font-["Neue_Montreal"] tracking-tighter'>EYE-</h1>
                <h1 className='text-7xl font-extrabold font-["Neue_Montreal"] tracking-tighter'>OPENING</h1>
                <svg className='mt-[25vw]' width="65" height="25" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-1/2  text-white ">
                <h1 className='text-7xl font-extrabold font-["Neue_Montreal"] tracking-tighter'>PRESENTATIONS</h1>
                <div className='text-sm '>
                    <div className='mt-10'>
                    <h1 className='mb-2'>S:</h1>
                    <a className='block' href="#">Instgram</a>
                    ...
                    <div className='mt-10'>
                        ...
                        <a className='block' href="#">202-1965 W 4th Ave</a>
                        <a className='block' href="#">Vancouver, Canada</a>
                        <br />
                        <a className='block' href="#">30 Chukarina St</a>
                        <a className='block' href="#">Lviv, Ukraine</a>
                    </div>
                    <div className='mt-10'>
                        <h1 className='mb-2'>E:</h1>
                        <a className='block' href="#">hello@ochi.design</a>
                    </div>
                    </div>
                    <div className=' text-sm ml-[40vw] -mt-[20vw] flex-col'>
                        <h1 className='mb-2 '>M:</h1>
                        <a className='block' href="#">Home</a>
                        <a className='block' href="#">Service</a>
                        <a className='block' href="#">Our Work</a>
                        <a className='block' href="#">About Us</a>
                        <a className='block' href="#">Insights</a>
